...
var AbstractModel = function () {
  ...
  function AbstractModel() {
    ...
    var appId = 'gojhlg6h2w0cqh2wctysoj2bun8ex5u2mbc0cyrq0ibp5h8l';
    var appKey = 'iddxkuoz8teq1kt3kb9sluac9nfzytnr3rytcndzu2p0ur2l';
  ...
  _createClass(AbstractModel, [{
    key: 'userLogin',
    value: function userLogin(params, succ, fail) {
      _leancloudStorage2.default.User.logInWithMobilePhone(params.mobilePhoneNumber, params.password).then(function (loginedUser) {
    ...
    key: 'upgradeProfile',
    value: function upgradeProfile(params, succ, fail) {
      console.log(params);
      var username = params.username,
          school = params.school,
          department = params.department,
          major = params.major,
          adminYear = params.adminYear,
    ...
    key: 'registerUser',
    value: function registerUser(params, succ, fail) {
    ...
    key: 'getPaperList',
    value: function getPaperList(params, succ, fail) {
      var query = new _leancloudStorage2.default.Query('papers');
    ...
    key: 'getMomentsList',
    value: function getMomentsList(params, succ, fail) {
      var query = new _leancloudStorage2.default.Query('Moments');
    ...
    key: 'savePaper',
    value: function savePaper(params, succ, fail) {
      var objPapers = _leancloudStorage2.default.Object.extend('papers');
      var todoPapers = new objPapers();
    ...
    key: 'saveMoments',
    value: function saveMoments(params, succ, fail) {
      var objMoments = _leancloudStorage2.default.Object.extend('Moments');
      var todoMoments = new objMoments();
    ...
    key: 'getThisWordList',
    value: function getThisWordList(params, succ, fail) {
      var query = new _leancloudStorage2.default.Query('wordLists');
    ...
    key: 'updataWordLists',
    value: function updataWordLists(params, succ, fail) {
      var vacabularyId = '';
      var query = new _leancloudStorage2.default.Query('wordLists');
      query.equalTo('paperId', params.paperId);
      query.find().then(function (results) {
        ...
        var WordLists = _leancloudStorage2.default.Object.createWithoutData('wordLists', vacabularyId);
    ...
    key: 'saveWordLists',
    value: function saveWordLists(params, succ, fail) {
      var WordLists = _leancloudStorage2.default.Object.extend('wordLists');
      var todoWordLists = new WordLists();
      ...
      todoWordLists.save().then(function (todo) {
        ...
        var Vocabulary = _leancloudStorage2.default.Object.extend('Vocabulary');
        var VocabularyLists = new Vocabulary();
        // VocabularyLists.set('userId', params.userId);
        // VocabularyLists.set('show', params.show);
        // VocabularyLists.set('paperId', params.paperId);
    ...
    key: 'getVocabulary',
    value: function getVocabulary(params, succ, fail) {
      var query = new _leancloudStorage2.default.Query('Vocabulary');
      query.equalTo('userId', params.userId);
      query.find().then(function (todo) {
        succ && succ(todo);
    ...
    key: 'updataVocabulary',
    value: function updataVocabulary(params, succ, fail) {
      var vacabularyId = '';
      var query = new _leancloudStorage2.default.Query('Vocabulary');
      ...
      query.find().then(function (results) {
        ...
        var Vocabulary = _leancloudStorage2.default.Object.createWithoutData('Vocabulary', vacabularyId);
    ...
    key: 'uploadFile',
    value: function uploadFile(params, progress, succ, fail) {
      var file = new _leancloudStorage2.default.File(params.name, params.localFile);
      file.save({ onprogress: function onprogress(e) {
          progress && progress(e);
        } }).then(function (file) {
...
var userModel = new AbstractModel();
...
// 页面管理类
var PageManager = function (_Component) {
  _inherits(PageManager, _Component);

  function PageManager(props) {
    _classCallCheck(this, PageManager);

    var _this = _possibleConstructorReturn(this, (PageManager.__proto__ || Object.getPrototypeOf(PageManager)).call(this, props));

    _this.forward = _this.forward.bind(_this);
    _this.routerHistory = _this.props.history;
    _this.routerMatch = _this.props.match;
    return _this;
  }
  ...
  _createClass(PageManager, [{
    ...
    key: 'forward',
    value: function forward(viewPath, option) {
      console.log(this);
...
var BasicExample = function BasicExample() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_reactRouterDom.Route, { path: '/myAccount', component: _MyAccount2.default }),
      _react2.default.createElement(_reactRouterDom.Route, { path: '/myWordList/:paperId', component: _MyWordList2.default }),
      _react2.default.createElement(_reactRouterDom.Route, { path: '/vocabulary', component: _Vocabulary2.default }),
...
var NavBar = function NavBar(props) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement('img', { className: 'user-header', src: imgUrl })
    )
  );
};
...
var Taps = function (_Component) {
  _inherits(Taps, _Component);

  function Taps(props) {
    _classCallCheck(this, Taps);

    var _this = _possibleConstructorReturn(this, (Taps.__proto__ || Object.getPrototypeOf(Taps)).call(this, props));
  ...
  _createClass(Taps, [{
    ...
    value: function render() {
      ...
      var list = label.map(function (value, index) {
        var tabclass = index === _this2.state.active ? 'flex-full active' : 'flex-full';
        return _react2.default.createElement(
          'p',
          { className: tabclass, onClick: function onClick() {
              return _this2.tabClickHandler(index);
            } },
          value
        );
      });
...
var WordLine = function WordLine(props) {
  var _props$items = props.items,
      items = _props$items === undefined ? [] : _props$items;
        ...
        if (value.familiar) {
          ...
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { className: 'checkbox' },
              _react2.default.createElement('span', { className: 'circle spain' })
            ),
            _react2.default.createElement(
              'div',
              { className: 'flex-full word-info' },
      ...
      li = wordLists.map(function (value, i) {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'checkbox' },
            _react2.default.createElement('span', { className: haschecked })
          ),
          _react2.default.createElement(
            'div',
            { className: 'flex-full word-info' },
...
var AllMoments = function (_PageManager) {
  _inherits(AllMoments, _PageManager);

  function AllMoments(props) {
    _classCallCheck(this, AllMoments);

    var _this = _possibleConstructorReturn(this, (AllMoments.__proto__ || Object.getPrototypeOf(AllMoments)).call(this, props));
  ...
  _createClass(AllMoments, [{
    ...
    value: function render() {
      ...
      wordLists.map(function (value) {
        var temp = {
          time: _this6.formatDate(value.createdAt, 'yyyy-MM-dd'),
          paperTitle: value.attributes.paperTitle,
          content: value.attributes.paperDescription,
          btns: [{
            label: '查看全文',
            callback: function callback() {
              _this6.openNewView(value.attributes.fileUrl);
            }
          }, {
            label: '查看单词',
            callback: function callback() {
              _this6.viewWordList(value.id);
            }
          }]
        };
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'section',
          { className: 'flex-hrz' },
          this.state.accountType ? _react2.default.createElement(
            'div',
            { className: 'left' },
            _react2.default.createElement(
              'div',
            ...
            _react2.default.createElement('input', { className: '', type: 'text', placeholder: '\u8F93\u5165\u6587\u5B57', ref: 'address' }),
            _react2.default.createElement(
              'span',
              null,
              '\u4E0A\u4F20\u94FE\u63A5'
            ),
            _react2.default.createElement('input', { className: '', type: 'text', placeholder: '\u4E0A\u4F20\u94FE\u63A5' }),
            _react2.default.createElement(
              'span',
              null,
              '\u4E0A\u4F20\u56FE\u7247'
            ),
            _react2.default.createElement('input', { className: '', type: 'text', placeholder: '\u4E0A\u4F20\u56FE\u7247' }),
            _react2.default.createElement(
              'span',
              null,
              '\u4E0A\u4F20\u89C6\u9891'
            ),
            _react2.default.createElement('input', { className: '', type: 'text', placeholder: '\u4E0A\u4F20\u89C6\u9891' }),
            _react2.default.createElement(
              'div',
              { className: 'flex-init file-btn' },
            ...
            fileName ? _react2.default.createElement(
              ...
              _react2.default.createElement('input', { className: '', type: 'text', placeholder: fileName }),
              _react2.default.createElement(
                'span',
                null,
                '\u8BBA\u6587\u8BC4\u8BBA'
              ),
              _react2.default.createElement('input', { className: '', type: 'text', placeholder: '\u8F93\u5165\u8BBA\u6587\u8BC4\u8BBA' }),
              _react2.default.createElement(
                'span',
                null,
                '\u8BBA\u6587\u7C7B\u578B'
              ),
              _react2.default.createElement('input', { className: '', type: 'text', placeholder: '\u8F93\u5165\u8BBA\u6587\u7C7B\u578B' }),
              _react2.default.createElement(
                'div',
                { className: 'flex-init file-btn' },
                _react2.default.createElement('i', { className: 'iconfont icon-shangchuan1' }),
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_index.Taps, tabData),
...
var EditProfile = function (_PageManager) {
  _inherits(EditProfile, _PageManager);
  ...
  _createClass(EditProfile, [{
    ...
    value: function upgradeProfile() {
      ...
      _AbstractModel2.default.upgradeProfile(params, function (data) {}, function (error) {
        console.log(error);
      });
    }
  }, {
    key: 'userNameChange',
    value: function userNameChange() {
      this.setState({ username: event.target.value });
    }
  }, {
    key: 'schoolChange',
    value: function schoolChange() {
    ...
    key: 'majorChange',
    value: function majorChange() {
      this.setState({ major: event.target.value });
    }
  }, {
    key: 'adminYearChange',
    value: function adminYearChange() {
      this.setState({ adminYear: event.target.value });
    }
  }, {
    key: 'researchFieldChange',
    value: function researchFieldChange() {
    ...
    value: function render() {
      ...
      var _state2 = this.state,
          ...
          isShowloading = _state2.isShowloading;
      // 头部数据
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { className: 'group' },
              _react2.default.createElement('input', { type: 'text', onChange: this.userNameChange.bind(this), required: true, value: this.state.username }),
            ...
            _react2.default.createElement(
              'div',
              { className: 'group' },
              _react2.default.createElement('input', { type: 'text', onChange: this.schoolChange.bind(this), required: true, value: this.state.school }),
              _react2.default.createElement('span', { className: 'highlight' }),
              _react2.default.createElement('span', { className: 'bar' }),
              _react2.default.createElement(
                'label',
            ...
            _react2.default.createElement(
              'div',
              { className: 'group' },
              _react2.default.createElement('input', { type: 'text', onChange: this.departmentChange.bind(this), required: true, value: this.state.department }),
              _react2.default.createElement('span', { className: 'highlight' }),
              _react2.default.createElement('span', { className: 'bar' }),
              _react2.default.createElement(
                'label',
            ...
            _react2.default.createElement(
              'div',
              { className: 'group' },
              _react2.default.createElement('input', { type: 'text', onChange: this.majorChange.bind(this), required: true, value: this.state.major }),
              _react2.default.createElement('span', { className: 'highlight' }),
              _react2.default.createElement('span', { className: 'bar' }),
              _react2.default.createElement(
                'label',
            ...
            _react2.default.createElement(
              'div',
              { className: 'group' },
              _react2.default.createElement('input', { type: 'text', onChange: this.adminYearChange.bind(this), required: true, value: this.state.adminYear }),
              _react2.default.createElement('span', { className: 'highlight' }),
              _react2.default.createElement('span', { className: 'bar' }),
              _react2.default.createElement(
                'label',
            ...
            _react2.default.createElement(
              'div',
              { className: 'group' },
              _react2.default.createElement('input', { type: 'text', onChange: this.researchFieldChange.bind(this), required: true, value: this.state.researchField }),
              _react2.default.createElement('span', { className: 'highlight' }),
              _react2.default.createElement('span', { className: 'bar' }),
              _react2.default.createElement(
                'label',
          ...
          _react2.default.createElement(
            'div',
            { className: 'flex-init file-btn', onClick: this.upgradeProfile.bind(this) },
            _react2.default.createElement('i', { className: 'iconfont icon-shangchuan1' }),
            _react2.default.createElement(
              'span',
              null,
...
var Login = function (_Component) {
  ...
  function Login(props) {
    ...
    _this.userNmaehandleChange = _this.userNmaehandleChange.bind(_this);
    _this.pwdhandleChange = _this.pwdhandleChange.bind(_this);
    _this.loginFn = _this.loginFn.bind(_this);
    _this.loginBtn = _this.loginBtn.bind(_this);

    _this.registeruserNmaehandleChange = _this.registeruserNmaehandleChange.bind(_this);
    _this.registerPhonehandleChange = _this.registerPhonehandleChange.bind(_this);
    _this.registerpwdhandleChange = _this.registerpwdhandleChange.bind(_this);
    _this.rePwdhandleChange = _this.rePwdhandleChange.bind(_this);
    _this.registerFn = _this.registerFn.bind(_this);
    _this.registerBtn = _this.registerBtn.bind(_this);
  ...
  _createClass(Login, [{
    ...
    key: 'userNmaehandleChange',
    value: function userNmaehandleChange(event) {
    ...
    key: 'pwdhandleChange',
    value: function pwdhandleChange(event) {
    ...
    value: function loginFn() {
      ...
      var _state = this.state,
          mobilePhoneNumber = _state.mobilePhoneNumber,
      ...
      console.log(params);
      _AbstractModel2.default.userLogin(params, function (data) {
        window.localStorage.setItem('mobilePhoneNumber', mobilePhoneNumber);
        window.localStorage.setItem('password', password);
        _this2.props.history.push('viewPersonalAccount');
      }, function (error) {
        console.log(error);
      });
    }
    ...
    key: 'registeruserNmaehandleChange',
    value: function registeruserNmaehandleChange(event) {
      console.log(event.target.value);
    ...
    key: 'registerPhonehandleChange',
    value: function registerPhonehandleChange() {
      this.setState({ registerMobilePhoneNumber: event.target.value });
    }
    // 获取输入密码

  }, {
    key: 'registerpwdhandleChange',
    value: function registerpwdhandleChange() {
      this.setState({ registerPassword: event.target.value });
    }
    // 获取输入确认密码

  }, {
    key: 'rePwdhandleChange',
    value: function rePwdhandleChange() {
    ...
    value: function registerFn() {
      ...
      var _state2 = this.state,
          registerUserName = _state2.registerUserName,
          registerPassword = _state2.registerPassword,
          rePassword = _state2.rePassword,
          registerMobilePhoneNumber = _state2.registerMobilePhoneNumber;
      ...
      _AbstractModel2.default.registerUser(params, function (data) {
        _this3.props.history.push('viewPersonalAccount');
      }, function () {
        alert('注册失败');
      });
    }
      ...
      var login = _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'input' },
            _react2.default.createElement('input', { className: 'main-form', type: 'text', placeholder: ' \u624B\u673A\u53F7', onChange: this.userNmaehandleChange })
          ),
          _react2.default.createElement(
            'div',
            { className: 'input' },
            _react2.default.createElement('input', { className: 'main-form', type: 'password', placeholder: ' \u5BC6\u7801', onChange: this.pwdhandleChange })
          ),
          _react2.default.createElement(
            'div',
            { className: 'input' },
      ...
      var register = _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'input' },
            _react2.default.createElement('input', { className: 'main-form btn', type: 'button', value: '\u6CE8\u518C', onClick: this.registerFn })
          )
        )
      );
...
var Moments = function (_PageManager) {
  _inherits(Moments, _PageManager);

  function Moments(props) {
    _classCallCheck(this, Moments);

    var _this = _possibleConstructorReturn(this, (Moments.__proto__ || Object.getPrototypeOf(Moments)).call(this, props));
...
var MyAccount = function (_PageManager) {
  _inherits(MyAccount, _PageManager);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'ul',
              { className: 'flex-hrz paper-info', onClick: this.moments.bind(this) },
              _react2.default.createElement(
                'li',
                { className: 'flex-full border-left-line' },
                _react2.default.createElement(
...
var MyWordList = function (_PageManager) {
  _inherits(MyWordList, _PageManager);

  function MyWordList(props) {
    _classCallCheck(this, MyWordList);

    var _this = _possibleConstructorReturn(this, (MyWordList.__proto__ || Object.getPrototypeOf(MyWordList)).call(this, props));
    ...
    _this.userId = '';
    _this.saveWordListsFn = _this.saveWordListsFn.bind(_this);
    _this.initPagedata = _this.initPagedata.bind(_this);
    _this.switchWordType = _this.switchWordType.bind(_this);
    return _this;
  }

  _createClass(MyWordList, [{
    key: 'componentWillMount',
    value: function componentWillMount() {
      var _getQuery = this.getQuery(),
          paperId = _getQuery.paperId;
    ...
    key: 'getWordListsFn',
    value: function getWordListsFn(username) {
      var _this2 = this;
      ...
      _AbstractModel2.default.getThisWordList(params, function (data) {
        _this2.setState({
          isDataReady: false,
    ...
    key: 'saveWordListsFn',
    value: function saveWordListsFn() {
      var _this3 = this;
      ...
      console.log(params.userId);
      _AbstractModel2.default.updataWordLists(params, function (data) {
        _this3.setState({
          isShowloading: false
        });
      }, function (error) {
    ...
    value: function render() {
      ...
      if (this.state.isDataReady) return _react2.default.createElement(_index.Loading, null);
      var _state = this.state,
          wordLists = _state.wordLists,
          isShowloading = _state.isShowloading,
          wordType = _state.wordType;

      var tabData = {
        label: ['全部', '生词', '熟词'],
        callBack: function callBack(i) {
          _this4.switchWordType(i);
        }
        // 头部数据
      };var navBarData = {
        title: '论文助手',
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_index.NavBar, navBarData),
        _react2.default.createElement(_index.Taps, tabData),
        _react2.default.createElement(_index.WordList, wordListData),
        isShowloading ? _react2.default.createElement(_index.Loading, null) : null,
        _react2.default.createElement(
          'div',
          { className: 'save', onClick: this.saveWordListsFn },
          '\u4FDD\u5B58'
        )
      );
    }
...
var Vocabulary = function (_PageManager) {
  _inherits(Vocabulary, _PageManager);
  ...
  _createClass(Vocabulary, [{
    ...
    key: 'getVocabulary',
    value: function getVocabulary(userId) {
      var _this2 = this;
      ...
      //getThisWordList，得到当前的WordList,而不是全部的
      _AbstractModel2.default.getVocabulary(params, function (data) {
        _this2.setState({
          isDataReady: false,
    ...
    value: function saveWordListsFn() {
      ...
      _AbstractModel2.default.updataVocabulary(params, function (data) {}, function (error) {
        console.log(error);
      });
    }
    // 找到对应的单词
